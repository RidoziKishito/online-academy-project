...
INSERT INTO "public"."users" ("user_id", "full_name", "email", "password_hash", "role", "bio", "avatar_url", "is_verified", "otp_secret", "otp_expires_at", "oauth_provider", "oauth_id", "created_at") VALUES
	...
	(30, 'Hoàng Văn Em', 'em.hoang@email.com', '$2b$10$02IAXn2UlYMcyKV99F9ojOH8Dtil8LfsqmHtAHbEzJ0.yrnaFNxuy', 'instructor', 'Graphic design and UI/UX instructor', 'https://i.pravatar.cc/150?img=5', true, NULL, NULL, NULL, NULL, '2025-10-22 18:12:03.301701'),
	(31, 'Vũ Thị Phương', 'phuong.vu@email.com', '$2b$10$02IAXn2UlYMcyKV99F9ojOH8Dtil8LfsqmHtAHbEzJ0.yrnaFNxuy', 'instructor', 'Digital marketing expert with 8 years of experience', 'https://i.pravatar.cc/150?img=6', true, NULL, NULL, NULL, NULL, '2025-10-22 18:12:03.301701'),
	(32, 'System Admin', 'admin@academy.com', '$2b$10$02IAXn2UlYMcyKV99F9ojOH8Dtil8LfsqmHtAHbEzJ0.yrnaFNxuy', 'admin', NULL, 'https://i.pravatar.cc/150?img=7', true, NULL, NULL, NULL, NULL, '2025-10-22 18:12:03.301701'),
	...
	(29, 'Phạm Thị Dung', 'dung.pham@email.com', '$2b$10$93wQCs2ZXk9OfVNTcMjelOPlYrqKZGvAeJ8C8OKEu4oiw/c4uwlb2', 'instructor', 'Web development expert with 10 years of experience', 'https://i.pravatar.cc/150?img=4', true, NULL, NULL, NULL, NULL, '2025-10-22 18:12:03.301701'),
...
<ul>
	...
	<li>Ability to use Terminal or CMD</li>
	<li>Familiarity with REST APIs is a plus</li>
</ul>
', 'approved'),
...
<ul>
	<li>Basic understanding of the internet and social media</li>
	<li>Interest in online advertising, SEO, and content</li>
...
<ul>
	<li>Basic JavaScript or ReactJS knowledge</li>
	<li>An Android/iOS phone to test apps</li>
	<li>Familiarity with VS Code or Android Studio</li>
</ul>
', 'approved'),
...
<ul>
	...
	<li>Experience using VS Code or a similar IDE</li>
	<li>Motivation to learn practical full‑stack web development</li>
</ul>
', 'approved'),
...
<ul>
	...
	<li>Python installed or access to Google Colab</li>
</ul>
', 'approved'),
...
<ul>
	...
	<li>Interest in creativity and art</li>
	<li>No experience with Photoshop or Illustrator required</li>
</ul>
', 'approved'),
...
<ul>
	<li>Facebook or Instagram account</li>
	<li>Interest in building a personal brand</li>
	<li>No advanced marketing knowledge required</li>
</ul>
', 'approved');
