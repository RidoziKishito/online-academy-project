...
**Trước:**
```html
<div class="col-md-4">  <!-- Bị cramped trên mobile -->
```
...
**Responsive Sizes:**
```css
h1 { font-size: 1.75rem !important; }  /* vs 2.5rem desktop */
h2 { font-size: 1.5rem !important; }   /* vs 2rem desktop */
h3 { font-size: 1.25rem !important; }  /* vs 1.75rem desktop */
```
